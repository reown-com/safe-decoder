  ...
  describe('Mock Implementations', () => {
    ...
    describe('decodeMultiSendTransactions', () => {
      ...
      const mockDecodeMultiSendTransactions = (data: string): any[] => {
        ...
        if (data === '001234567890123456789012345678901234567890010987654321098765432109876543210987654321') {
          return [
            {
              operation: 0,
              to: '0x1234567890123456789012345678901234567890',
        ...
        if (data === '') {
          const recipients = [
            '0x1c44478a9a1c60b4f555aaabc9c510eaf3927071',
            '0xfcffb73c67382ef6f5d5d3ea3d6118020ffc71ae',
            '0xd8c3307178c15cb2cf89d1d0ab0f5e2ba7af7de2',
            '0x2239ab1cb9e1bea7a994cbf75bb6ea5ff1d919f4'
          ];
          ...
          return recipients.map(recipient => ({
            ...
            value: '0',
            dataLength: 68,
            data: `0xa9059cbb000000000000000000000000${recipient.slice(2)}000000000000000000000000000000000000000000000000016345785d8a0000`
          }));
        }
        
        // For other multisend transactions
        return mockDecodeMultiSendTransactions(data);
      };
      ...
      it('should decode multisend with multiple transfer calls', () => {
        const multiTransferHex = '';
        
        const result = mockDecodeMultiSendTransactions(multiTransferHex);
        
        expect(result).toHaveLength(4);
        
        // Check all transactions have the same pattern
        for (let i = 0; i < 4; i++) {
          expect(result[i].operation).toBe(0);
          expect(result[i].to).toBe('0xef4461891dfb3ac8572ccf7c794664a8dd927945');
          expect(result[i].value).toBe('0');
          expect(result[i].dataLength).toBe(68);
          expect(result[i].data.slice(0, 10)).toBe('0xa9059cbb'); // Transfer function signature
        }
        
        // Check specific recipients for each transfer
        expect(result[0].data.slice(10, 74)).toContain('1c44478a9a1c60b4f555aaabc9c510eaf3927071');
        expect(result[1].data.slice(10, 74)).toContain('fcffb73c67382ef6f5d5d3ea3d6118020ffc71ae');
        expect(result[2].data.slice(10, 74)).toContain('d8c3307178c15cb2cf89d1d0ab0f5e2ba7af7de2');
        expect(result[3].data.slice(10, 74)).toContain('2239ab1cb9e1bea7a994cbf75bb6ea5ff1d919f4');
        
        // Check amount is the same for all transfers
        const amount = '016345785d8a0000'; // 100000000000000000 (0.1 ETH)
        for (let i = 0; i < 4; i++) {
          expect(result[i].data.slice(-16)).toBe(amount);
        }
      });
    });
    ...
    describe('decodeTransactionData', () => {
      ...
      const mockDecodeTransactionData = (data: string): any[] => {
        ...
        if (data.startsWith('0x1e83409a') || data.startsWith('1e83409a')) {
          return [
            {
              operation: 0,
              to: '0xaaaabbbb77779900000000000aaaaaa000aaa000',
        ...
        if (data.startsWith('0xa9059cbb') || data.startsWith('a9059cbb')) {
          return [
            {
              operation: 0,
              to: '0xabcdef1234567890abcdef1234567890abcdef12',
      ...
      it('should decode multisend data with multiple transfer calls', () => {
        const multiTransferData = '';
        
        const result = mockDecodeTransactionData(multiTransferData);
        
        expect(result).toHaveLength(4);
        
        // All transactions should be to the same contract
        for (let i = 0; i < 4; i++) {
          expect(result[i].to).toBe('0xef4461891dfb3ac8572ccf7c794664a8dd927945');
          expect(result[i].operation).toBe(0);
          expect(result[i].value).toBe('0');
