  ...
  describe('Mock Implementations', () => {
    ...
    describe('decodeTransactionData', () => {
      ...
      const mockDecodeTransactionData = (data: string): any[] => {
        ...
        const result = mockDecodeTransactionData(data);
    ...
    describe('tryDecodeFunctionData', () => {
      ...
      it('should decode complex multiSend function data with offset and length', () => {
        const data = '';
